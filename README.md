...
```shell
gem install ./iterable-1.0.1.gem
```
(for development, run `gem install --dev ./iterable-1.0.1.gem` to install the development dependencies)
...
*Iterable::UsersApi* | [**get_user**](docs/UsersApi.md#get_user) | **GET** /api/users/{email} | Get a user by email (path parameter)
*Iterable::UsersApi* | [**get_user_0**](docs/UsersApi.md#get_user_0) | **GET** /api/users/getByEmail | Get a user by email (query parameter)
*Iterable::UsersApi* | [**get_user_by_id**](docs/UsersApi.md#get_user_by_id) | **GET** /api/users/byUserId | Get a user by userId (query parameter)
*Iterable::UsersApi* | [**get_user_by_id_0**](docs/UsersApi.md#get_user_by_id_0) | **GET** /api/users/byUserId/{userId} | Get a user by userId (path parameter)
